...
//versiune copiata si modificata- am scos butonul de MODIFICARE 
    ...
    $.fn.Tabledit = function(options) {
        ...
        var defaults = {
            ...
            buttons: {
                ...
                delete: {
                    class: 'button',
                    html: '<span class="fa fa-trash" style="font-size:18px"></span>',
                    action: 'delete'
                },
                save: {
            ...
            columns: {
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        $table.find('tr:gt(0)').append('<td style="white-space: nowrap; width: 5%;">' + toolbar + '</td>');
                    }
                }
            }
        };
        ...
        var Delete = {
            ...
            submit: function(td) {
				...
				// !!!!!!!!!!!!!!!!! adaugat de bianca : reincarc pagina ca sa nu mai vad randul sters
				location.reload();				
